        ...
        <div class="container row m-t-10">
            ...
            <div class="col-sm-8">
                <div class="card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="password" name="password" class="form-control" required="" placeholder="Password.." autocomplete="off" value="{{ old('password') }}">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                          <p>Sudah punya akun? Silahkan login <a href="{{ url('user/login') }}" class="text-primary m-l-5"><b>disini</b></a></p>
