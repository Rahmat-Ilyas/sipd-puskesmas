...
$pemeriksaan = $pemeriksaan->orderBy('id', 'desc')->where('user_id', Auth::user()->id)->get();
@endphp
<!-- ============================================================== -->
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-info" data-toggle="modal" data-target=".modal-detail{{ $dta->id }}" data-toggle1="tooltip" title="Detail Pasien"><i class="fa fa-list"></i> Detail</button>
									</td>
								</tr>
								@endforeach
							</tbody>
