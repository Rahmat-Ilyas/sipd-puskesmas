...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td width="80" class="text-center">
                                                <button class="btn btn-sm btn-info" data-toggle="modal"
                                                    data-target=".modal-detail{{ $dta->id }}"><i
                                                        class="fa fa-list"></i> Detail</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    @foreach ($pemeriksaan as $i => $dta)
        <!-- MODAL DETAIL -->
        <div class="modal modal-detail{{ $dta->id }}" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td width="200">No. Rekam Medik</td>
                                    <td width="10">:</td>
                                    <td>{{ $dta->user->no_rekam_medik }}</td>
                                </tr>
                                <tr>
