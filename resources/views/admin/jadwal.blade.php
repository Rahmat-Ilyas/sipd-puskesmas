...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td width="80">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target=".modal-jadwal{{ $dta->id }}" data-toggle1="tooltip"
                                                title="Atur Jadwal"><i class="fa fa-clock-o"></i> Atur Jadwal</button>
                                        </td>
                                    </tr>
                                    <?php $no++; 
							} ?>
    ...
    @foreach ($data->all() as $dta)
        <!-- MODAL ATUR JADWAL -->
        <div class="modal modal-jadwal{{ $dta->id }}" role="dialog" aria-labelledby="myLargeModalLabel"
                    ...
                    <div class="modal-body" style="padding-bottom: 0;">
                        <form method="POST" action="{{ url('admin/update/setjadwal') }}">
                            ...
                            <div class="set-jadwal">
                                    ...
                                    <tbody class="content-jadwal">
                                            ...
                                            <tr class="item-jadwal">
                                                <td>
                                                    <div class="form-inline">
                                                        <select class="form-control input-sm hari-awal" name="hari_awal[]"
                                                            required="">
                                                        ...
                                                        <small><b>s/d</b></small>
                                                        <select class="form-control input-sm hari-akhir"
                                                            name="hari_akhir[]">
                                                            <option></option>
                                                            @php
                                                                foreach ($days as $day) {
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        <input type="time" class="form-control input-sm jam-awal"
                                                            name="jam_awal[]" value="{{ $jam_awal }}" required="">
                                                        <small><b>s/d</b></small>
                                                        <input type="time" class="form-control input-sm jam-akhir"
                                                            name="jam_akhir[]" value="{{ $jam_akhir }}" required="">
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-sm btn-danger {{ $class }}"
                                        ...
                                        @if ($ada == 0)
                                            <tr class="item-jadwal">
                                                ...
                                                <td class="text-center">
                                                    <a href="#" role="button" class="btn btn-sm btn-danger" disabled=""><i
                                ...
                                <small class="text-info info" hidden="">Info: Silahkan kosongkan pilihan hari selanjutnya
                                    jika jadwal hanya 1 hari<br> </small>
                                <a href="#" role="button" class="btn btn-sm btn-primary m-t-5 tambah"><i
