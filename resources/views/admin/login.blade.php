...
<head>
    ...
    <title>Login Admin - UPT Puskesmas Bontonompo II</title>
        ...
        <div class="wrapper-page">
        	<div class=" card-box">
                <div class="panel-heading"> 
                    ...
                    <h3 class="text-center"><strong class="text-custom">LOGIN ADMIN</strong> </h3>
                    <h3 class="text-center">Puskesmas Bontonompo II</h3>
                </div> 


                <div class="panel-body">
                    <form class="form-horizontal m-t-0" method="POST" action="{{ route('admin.login.submit') }}">
                        @csrf
