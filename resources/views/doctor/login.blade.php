...
<head>
    ...
    <title>Login Doctor - UPT Puskesmas Bontonompo II</title>
        ...
        <div class="wrapper-page">
        	<div class=" card-box">
                <div class="panel-heading"> 
                    ...
                    <h3 class="text-center"><strong class="text-custom">LOGIN DOCTOR</strong> </h3>
                    <h3 class="text-center">Puskesmas Bontonompo II</h3>
                </div> 


                <div class="panel-body">
                    <form class="form-horizontal m-t-0" method="POST" action="{{ route('doctor.login.submit') }}">
                        @csrf
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <label class="form-label">NIP</label>
                                <input class="form-control" type="text" name="nip" required="" placeholder="NIP..." value="{{ old('nip') }}">
                            </div>
                        </div>
